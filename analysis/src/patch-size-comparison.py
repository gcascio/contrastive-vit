...
for i, size in enumerate(['s', 't', 'xt']):
    ...
    ax[i].plot(patch8[0], patch8[1], label='Patch size 8px')
    ax[i].plot(patch16[0], patch16[1], label='Patch size 16px')
    ax[i].plot(patch32[0], patch32[1], label='Patch size 32px')
